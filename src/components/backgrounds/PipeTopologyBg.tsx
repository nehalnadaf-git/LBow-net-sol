...
/**
 * PipeTopologyBg — minimal fine-line grid background.
 * Replaces the old complex pipeline topology with a clean, light grid.
 */
    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0 select-none">
      ...
      >
        <defs>
          ...
          {/* Radial vignette — visible in centre, fades at edges */}
