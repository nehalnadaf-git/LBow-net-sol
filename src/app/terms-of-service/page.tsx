      ...
      <section className="relative w-full pt-28 sm:pt-36 md:pt-44 pb-16 sm:pb-24 bg-[#F8F9FA]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-16 xl:px-24">
          <nav className="font-body text-xs text-[#6B7280] mb-8 flex gap-2 items-center">
            ...
            <span>/</span>
            <span className="text-[#0A0F1E]">Terms of Service</span>
          </nav>
          ...
          <div className="font-body text-[#374151] space-y-8">
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">2. Products and Services</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">3. Orders and Payment</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">4. Delivery</h2>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">5. Product Warranty</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">6. Returns and Complaints</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">7. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">8. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-[#0A0F1E] mb-3">9. Contact</h2>
